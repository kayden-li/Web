...
Vcity.allCity = [
		'北京|beijing|bj','天津|tianjin|tj','上海|shanghai|sh',
		'重庆|chongqing|cq','河北|hebei|hb','山西|shanxi|sx',
		'辽宁|liaoning|ln','吉林|jilin|jl','黑龙江|heilongjiang|hlj',
		'江苏|jiangsu|js','浙江|zhejiang|zj','安徽|anhui|ah','福建|fujian|fj','江西|jiangxi|jx',
		'山东|shandong|sd','河南|henan|hn','湖北|hubei|hb','湖南|hunan|hn',
		'广东|guangdong|gd','海南|hainan|hn','四川|sichuan|sc',
		'贵州|guizhou|gz','云南|yunnan|yn','陕西|shannxi|sx',
		'甘肃|gansu|gs','青海|qinghai|qh','台湾|taiwan|tw',
		'内蒙古|neimenggu|nmg','广西|guangxizhuangzu|gxzz','西藏|xizang|xz',
		'宁夏|ningxiahuizu|nxhz','新疆|xinjiangweiwuer|xjwwe','香港|xianggang|xg','澳门|aomen|am'];
