...
/**
 * Servlet implementation class recook
 */
/**
 * * <b>Description:</b>更新菜谱信息<br>
 * 
 * @author 李帆
 * @version 1.0
 * @Note <b>ProjectName:</b> MyWeb <br>
 * 		<b>PackageName:</b> com.servlet <br>
 * 		<b>ClassName:</b> Recook <br>
 * 		<b>Date:</b> 2018年12月3日 下午8:54:13
 */

@WebServlet("/recook")
public class Recook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int flag = Controller.update_Food(food);
		if (flag == 1)
			writer.append("加工成功了哦！");
		else
			writer.append("加工失败了哦！");
	}
